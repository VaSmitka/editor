...
exports.user = exports.userMethods = exports.userPath = void 0;
...
const user = (app) => {
    ...
    app.use(exports.userPath, new users_class_1.UserService((0, users_class_1.getOptions)(app)), {
    ...
    // Initialize hooks
    app.service(exports.userPath).hooks({
        around: {
