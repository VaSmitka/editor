...
const avatar1 = import.meta.env.VITE_REACT_APP_ASSETS_BUCKET + '/avatars/avatar1.webp';
const avatar2 = import.meta.env.VITE_REACT_APP_ASSETS_BUCKET + '/avatars/avatar2.webp';
...
export const dashboardNews: Array<Post> = [
  {
    ...
    date: Date.now(),
    img: import.meta.env.VITE_REACT_APP_ASSETS_BUCKET + '/med-news/Rectangle_440_1_ayb6yf.webp',
    avatarUrl: avatar1,
    author: 'Dr. Dan Reed',
    tags: [health, covid],
  },
  {
    ...
    date: Date.now(),
    img: import.meta.env.VITE_REACT_APP_ASSETS_BUCKET + '/med-news/Rectangle_441_1_iq4y2p.webp',
    avatarUrl: avatar2,
