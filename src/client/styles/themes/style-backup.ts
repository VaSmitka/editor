...
export default createStyles(() => ({
  ...
  '.ant-click-animating-node,[ant-click-animating-without-extra-node=true]::after': {
    ...
    boxShadow: ['0 0 0 0 var(--ant-primary-color)', '0 0 0 0 var(--antd-wave-shadow-color)'],
    opacity: 0.2,
  ...
  '@keyframes waveEffect': {
    '100%': {
      boxShadow: ['0 0 0 var(--ant-primary-color)', '0 0 0 6px var(--antd-wave-shadow-color)'],
    },
  },
  ...
  '.ant-drawer-left>.ant-drawer-content-wrapper': {
    ...
    bottom: '0',
    left: '0',
    boxShadow: '6px 0 16px -8px rgba(0,0,0,.08),9px 0 28px 0 rgba(0,0,0,.05),12px 0 48px 16px rgba(0,0,0,.03)',
  },
  ...
  '.ant-drawer-top>.ant-drawer-content-wrapper': {
    ...
    right: '0',
    left: '0',
    boxShadow: '0 6px 16px -8px rgba(0,0,0,.08),0 9px 28px 0 rgba(0,0,0,.05),0 12px 48px 16px rgba(0,0,0,.03)',
  },
  ...
  '.segmented-item-selected': {
    backgroundColor: '#fff',
    borderRadius: '7px',
    boxShadow: '0 2px 8px -2px rgba(0,0,0,.05),0 1px 4px -1px rgba(0,0,0,.07),0 0 1px 0 rgba(0,0,0,.08)',
  },
