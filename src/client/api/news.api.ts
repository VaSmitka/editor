...
const avatar3 = import.meta.env.VITE_REACT_APP_ASSETS_BUCKET + '/avatars/avatar3.webp';
const avatar4 = import.meta.env.VITE_REACT_APP_ASSETS_BUCKET + '/avatars/avatar4.webp';
